...
namespace AppStudio
{
    ...
    {
        public const string APP_NAME = "Django Django FanApp";
        ...
        {
            TileServices.CreateFlipTile(@"Unofficial FanApp", @"Made by TrunkBT", @"DataImages/FlipSquareTile.jpg", "DataImages/FlipWideTile.jpg");
        }
        #endregion
    }
}
