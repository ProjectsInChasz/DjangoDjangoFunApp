...
{
    public class YouTubeChannelViewModel : ViewModelBase<YouTubeSchema>
    {
            ...
            get
            {
                if (itemClickCommand == null)
                {
                    itemClickCommand = new RelayCommandEx<YouTubeSchema>(
                        (item) =>
                        {
                            NavigationServices.NavigateToPage("YouTubeChannelDetail", item);
                        });
                }
        ...
        {
            return new YouTubeChannelDataSource(); // YouTubeDataSource
        }
        ...
        {
            NavigationServices.NavigateToPage("YouTubeChannelList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("YouTubeChannelDetail");
        }
